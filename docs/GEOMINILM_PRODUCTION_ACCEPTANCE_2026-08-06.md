# GeoMiniLM Production Acceptance Gate - 2026-08-06

## Locked Candidate

- Candidate commit: `428af8d80f48b7a1a5ccc00f9ea3f918b774ef77`
...
The frozen validation set was evaluated once for this gate. No retuning or second frozen-set attempt was performed.

## Gate Decision

Status: **FAIL**

Dashboard integration remains blocked. A new GeoMiniLM performance cycle is opened for training/development-only work; the frozen production validation set must not be used for iterative tuning.
...
The candidate beats the honest baseline and passes integrity checks, but fails the locked score threshold.
